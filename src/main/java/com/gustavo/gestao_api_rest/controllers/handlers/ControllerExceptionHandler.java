package com.gustavo.gestao_api_rest.controllers.handlers;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> methodArgumentNotValidation(MethodArgumentNotValidException e, HttpServletRequest request) {
        ...
        // for vai percorrer todos os atributos da entidade e gerar os exception que colocamos nas mensagens dos atributos
